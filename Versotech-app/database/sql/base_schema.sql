-- Script de referência para criação das tabelas base e carga inicial
-- Pode ser executado em um banco PostgreSQL compatível com as migrations do projeto.
...
CREATE TABLE produtos_base (
    ...
    prod_prof   TEXT,
    prod_und    VARCHAR(10),
    prod_atv    BOOLEAN DEFAULT FALSE,
    prod_dt_cad TEXT
);
...
DROP TABLE IF EXISTS precos_base CASCADE;
